...
parser.add_argument('--cfg', type=str, default='experiments/udatban_r50_l234/config.yaml',
...
def main():
    ...
    if args.model == 'sam-da-track-b':
        cfg.DATASET.VIDEOS_PER_EPOCH = cfg.DATASET.VIDEOS_PER_EPOCH_B
        cfg.DATASET.NAT.ANNO = cfg.DATASET.NAT.ANNO_B
    elif args.model == 'sam-da-track-s':
        cfg.DATASET.VIDEOS_PER_EPOCH = cfg.DATASET.VIDEOS_PER_EPOCH_S
        cfg.DATASET.NAT.ANNO = cfg.DATASET.NAT.ANNO_S
    elif args.model == 'sam-da-track-t':
        cfg.DATASET.VIDEOS_PER_EPOCH = cfg.DATASET.VIDEOS_PER_EPOCH_T
        cfg.DATASET.NAT.ANNO = cfg.DATASET.NAT.ANNO_T
    elif args.model == 'sam-da-track-n':
        cfg.DATASET.VIDEOS_PER_EPOCH = cfg.DATASET.VIDEOS_PER_EPOCH_N
        cfg.DATASET.NAT.ANNO = cfg.DATASET.NAT.ANNO_N
    else:
        raise ValueError('Unknown model name, please select from [sam-da-track-b, sam-da-track-s, sam-da-track-t, sam-da-track-n]')
